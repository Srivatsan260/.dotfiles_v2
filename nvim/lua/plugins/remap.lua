...
vim.keymap.set("n", "<leader><leader>c", "<cmd> so " .. config_path .. "/after/plugin/color.lua<CR>")
vim.keymap.set("n", "<leader><leader>t", "<cmd> so " .. config_path .. "/after/plugin/treesitter.lua<CR>")
vim.keymap.set("n", "<leader><leader>l", "<cmd> so " .. config_path .. "/lua/plugins/lsp_zero.lua<CR>")
...
vim.keymap.set("n", "<leader>fr", "<cmd>FloatermNew --wintype=float --height=0.9 --width=0.9 ranger<CR>")
...
vim.keymap.set("c", "<CR>", function() return vim.fn.getcmdtype() == '/' and '<CR>zzzv' or '<CR>' end,
         {expr = true})
